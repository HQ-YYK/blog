      ...
      <div id="about-content-container">
        ...
        <svg id="skills-svg" viewBox="-2 -2 506 815" xmlns="http://www.w3.org/2000/svg"
          ...
          <g id="about-svg-header">
            ...
            <polyline id="about-profile-background" className="about-box-background"
              points="65,170 145,170 145,50 135,40 135,10 125,0 70,0 10,0 0,10 0,160 10,170" />


            {/* Header Content Background */}
            <polyline id="about-header-background" className="about-box-background"
            ...
            <defs>
              <mask id="about-profile-picture-mask">
                ...
                {/* White Background */}
                <polygon fill="white" points="65,170 145,170 145,50 135,40 135,10 125,0 70,0 10,0 0,10 0,160 10,170" />
                {/* Rect to make white background visible */}
                <rect id="about-profile-picture-mask-rect" fill="black" width="145" height="170" style={{ transition: '1.2s' }} x="0" y="-0" />
              </mask>
            </defs>

            {/* Profile Picture */}
            <image href="/skills-profile-picture.png" opacity="1" height="170" width="145" x="2" mask="url(#about-profile-picture-mask)" imageRendering="optimizeSpeed" />

            {/* Profile Picture line that moves up on animation */}
            <g mask="url(#about-profile-picture-mask)">
              <rect fill="url(#about-profile-picture-mask-gradient)" height="35" width="155" y="170" id="about-profile-picture-gradient" style={{ transition: '1.2s' }} />
            </g>

            {/* Profile Picture Borders */}
            <polyline className="about-box-line" points="65,170 10,170 0,160 0,10 10,0 70,0" />
            <polyline className="about-box-line" points="65,170 145,170 145,50 135,40 135,10 125,0 70,0" />

            {/* Header Content Borders */}
            <polyline className="about-box-line" points="145,85 250,85 260,95 490,95 500,105 500,135" />
            <polyline className="about-box-line" points="145,170 190,170 200,160 490,160 500,150 500,135" />

            {/* Header Content */}
            <g transform="translate(170 118)" fill="#34bfff" fontWeight="bold">
              <text x="0" y="0" fontSize="12" className="about-header-upper-text">Name :</text>
              <text x="0" y="20" fontSize="18" className="about-header-lower-text">David</text>
              <text x="110" y="0" fontSize="12" className="about-header-upper-text">Age :</text>
              <text x="110" y="20" fontSize="18" className="about-header-lower-text">23</text>
              <text x="200" y="0" fontSize="12" className="about-header-upper-text">From :</text>
              <text x="200" y="20" fontSize="18" className="about-header-lower-text">Germany</text>
            </g>
          </g>
          ...
          <g transform="translate(0 188)" id="about-svg-skills">
            {/* Background */}
            <polyline id="about-skills-background" className="about-box-background"
            ...
            {/* Lines */}
            <polyline className="about-box-line"
            ...
            {/* Header Text */}
            <text x="71" y="25" className="about-header" fontSize="18" fontWeight="bold">SKILLS</text>
          ...
          <g transform="translate(0 459)" id="about-svg-about">
            ...
            {/* Background */}
            <polyline id="about-about-background" className="about-box-background"
            ...
            {/* Header Text */}
            <text x="73" y="25" className="about-header" fontSize="18" fontWeight="bold">ABOUT</text>
            ...
            <g transform="translate(10 65)">
              ...
              <mask id="about-pixel-mask-0">
                <rect className="about-pixel-mask-rect" x="6" y="7" height="20" width="64" fill="white" />
              </mask>
              <image mask="url(#about-pixel-mask-0)" className="about-pixel-image" height="64" width="64"
                href="/icons/baby-pixel.png" x="6" y="7" />

              {/* First Text */}
              <text x="88" y="33" className="about-text">At the age of 15, David first came in touch with
                UX</text>
              <text x="88" y="50" className="about-text">Design and app development.</text>
            </g>

            {/* Second Content */}
            <g transform="translate(10 145)">

              <use className="about-icon" href="#about-icon-background" x="405"></use>

              <mask id="about-pixel-mask-1">
                <rect className="about-pixel-mask-rect" x="413" y="6" height="20" width="64" fill="white" />
              </mask>
              <image mask="url(#about-pixel-mask-1)" className="about-pixel-image" height="64" width="64"
              ...
              {/* Second Text */}
              <text x="5" y="33" className="about-text">During his 4 years of military service,
                programming</text>
              <text x="5" y="50" className="about-text">has always been a passion of his.</text>
            </g>
            ...
            <g transform="translate(10 225)">
              ...
              <image mask="url(#about-pixel-mask-2)" className="about-pixel-image" height="64" width="64"
                href="/icons/rocket-pixel.png" x="6" y="7" />

              {/* Third Text */}
              <text x="88" y="33" className="about-text">Now, after professional coaching, David is looking
                for</text>
              <text x="88" y="50" className="about-text">new challenges to work as a web developer.</text>
            </g>
          </g>

          {/* Down Animation Lines */}
          <g transform="translate(145 76)">
            <polyline className="about-down-animation-line" points="0,0 110,0 120,10 325,10 333,18" />
          </g>
          <g transform="translate(195 192)">
            <polyline className="about-down-animation-line"
              points="0,0 8,0 13,5 13,22 110,22 120,32 275,32 283,40" />
          </g>
          <g transform="translate(403 496)">
            <polyline className="about-down-animation-line" points="0,0 70,0 78,8" />
          </g>

          {/* Up Animation Lines */}
          <g transform="translate(193 160)">
            <polyline className="about-up-animation-line" points="0,7 275,7 282,0" />
          </g>
          <g transform="translate(403 468)">
            <polyline className="about-up-animation-line" points="0,8 70,8 78,0" />
          </g>
          <g transform="translate(20 784)">
            <polyline className="about-up-animation-line" points="0,0 9,9 74,9 84,19 450,19 458,11" />
          </g>
